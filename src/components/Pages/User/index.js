...
// import file
import {actDeleteUserRequest, actFetchUsersRequest, confirmUserDelete, setTitlePage} from '../../../actions/index'
    ...
    handleDelete = () => {
        if(this.state.checked && !isEmpty( this.state.checked )){
            ...
            if (window.confirm('Are you sure you wish to delete this item?')) {
                Promise.resolve(this.props.actDeleteUserRequest(params)).then(() => {
                    this.getUsersData();
                })
            }
        }
                                ...
                                {users && users.list && users.list.map( (item, key) => {
                                    return (
                                        <tr key = {key} >
                                            ...
                                            <td>{ item.email }</td>
                                            <td> <Link to={`/user/edit/${item.id}`} > <img src="" className="penIcon" /> </Link> </td>
